...
class TestVersionManagerIncrement:
    ...
    def test_defaults_to_app_build_gradle_kts_when_no_path_given(self, tmp_path):
        # Arrange — Raven's default increment() target, unlike the explicit-path
        # calls above.
        ...
        # Act
        code, name = VersionManager(tmp_path).increment()
